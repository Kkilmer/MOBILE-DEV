...
const [detalhesVisiveis, setDetalhesVisiveis] = useState(false);
  ...
  return (
    <View style={styles.container}>
        ...
        <Image source={{ uri: 'https://avatars.githubusercontent.com/u/143044291?v=4' }}style={styles.imagemPerfil}/>
        ...
        {/* IMAGEM COM 'TouchableOpacity' PARA "VER MAIS/VER MENOS" */}
        ...
        {detalhesVisiveis && (
            ...
            <Text style={styles.textoDetalhe}>Email: kp827767@gmail.com</Text>
